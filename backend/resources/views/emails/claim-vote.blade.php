                    ...
                    <tr>
                        <td style="padding: 0 40px 40px; color: #333333; font-size: 15px; line-height: 1.7;">
                            ...
                            <p style="margin: 0 0 16px;">
                                A claim in your group <strong>{{ $claim->group->title }}</strong> has been approved by the group owner and is now ready for voting.
                            </p>
                            ...
                            <table style="width: 100%; border-collapse: collapse; margin: 0 0 20px;">
                                ...
                                <tr>
                                    <td style="padding: 8px 0; color: #666;">Voting Deadline</td>
                                    <td style="padding: 8px 0; font-weight: 600;">{{ $claim->voting_deadline?->format('M d, Y h:i A') }}</td>
                                </tr>
                            </table>

                            <p style="margin: 0 0 8px;">Please cast your vote:</p>

                            <p style="margin: 0 0 24px;">
                                <a href="{{ $voteUrl }}" style="display: inline-block; padding: 12px 28px; background: #00b4a0; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600;">Vote Now</a>
                            </p>

                            <p style="margin: 0; color: #666666; font-size: 13px;">
                                Or copy this link: <a href="{{ $voteUrl }}" style="color: #00b4a0; word-break: break-all;">{{ $voteUrl }}</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
