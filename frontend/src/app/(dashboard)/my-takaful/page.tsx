    ...
    <div className="main-container-wrapper">
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            className="lab-btn gradiant-greed-bg"
      ...
      {groups.length === 0 ? (
        <EmptyState
          icon="groups"
          message="No Takaful Groups Created"
          subtitle="Start your first Takaful group and invite members to join."
        >
        ...
        <div className="group-listing">
          {groups.map((group) => (
            <Link
              ...
              className="group-list-card tr-owner-group"
            >
              <div className="group-card-header">
                ...
                <span
                  className={`group-status-badge ${group.status || "active"}`}
                >
                  {group.status || "active"}
                </span>
              </div>
        ...
        <div className="dashboard-table-wrapper dashboard-common-table">
          <table>
            ...
            <tbody>
              {groups.map((group) => (
                <tr key={group.id} className="tr-owner-group">
                  <td>
